...
public class VentanaTienda extends JFrame {
    ...
    private JPanel crearPanelCatalogo() {
        ...
        scroll.setBorder(
                BorderFactory.createLineBorder(COLOR_HEADER_TABLA)
        );
        ...
        spinnerCantidad.setPreferredSize(
                new Dimension(60, 32)
        );
    ...
    private JPanel crearPanelCarrito() {
        ...
        JButton btnComprar = crearBoton(
                "✔ Confirmar Compra",
                COLOR_BOTON_COMPRAR
        );

        JButton btnVaciar = crearBoton(
                "✕ Vaciar Carrito",
                COLOR_BOTON_LIMPIAR
        );
    ...
    private JPanel crearStatusBar() {
        ...
        JLabel lbl = new JLabel(
                "BigSuplements © 2025 | SQLite conectado"
        );
    ...
    private void confirmarCompra() {
        ...
        int idVenta = productoDAO.registrarVenta(carrito, 1);
